                        ...
                        <div class="m-xs-b-5">
                            <div class="media-object">
                                ...
                                <div class="media-body p-xs-l-2">
                                    <span class="wt-medium">{{ $concert->getDate() }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="m-xs-b-5">
                            <div class="media-object">
                                ...
                                <div class="media-body p-xs-l-2">
                                <span class="wt-medium block">Doors at {{ $concert->getTime() }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="m-xs-b-5">
                            <div class="media-object">
                                ...
                                <div class="media-body p-xs-l-2">
                                    <span class="wt-medium block">{{ $concert->getTicketPriceInDollars() }}</span>
                                </div>
                            </div>
                        </div>
