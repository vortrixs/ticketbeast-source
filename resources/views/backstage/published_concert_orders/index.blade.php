    ...
    <div class="bg-light p-xs-y-4 border-b">
        <div class="container">
            <div class="flex-spaced flex-y-center">
                ...
                <div class="text-base">
                    <a href="{{ route('backstage.published_concert_orders.index', $concert) }}" class="wt-bold inline-block">
                        Orders
                    </a>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="card">
                    <div class="card-section border-b">
                        <p class="m-xs-b-4">This show is {{ $concert->percentTicketsSold() }}% sold out.</p>
                        <progress class="progress" value="{{ $concert->countTicketsSold() }}" max="{{ $concert->countTotalTickets() }}">{{ $concert->percentTicketsSold() }}%</progress>
                    </div>
                    <div class="row">
